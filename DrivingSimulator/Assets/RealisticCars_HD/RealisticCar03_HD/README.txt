...
Car has 2 openable doors. Just select "Car03_Door_Left" or any other door under:
"RealisticCar03_HD_Exterior_Complete / Car03_Body" and rotate it in Y axis.
...
Main Body part includes 2 materials. One for Car paint (RealisticCar03_Body - You can adjust color, metallic and smothness freely. 
Also You can make Your own custom paint texture using Car03_Body_PSD file) and second for everything else 
(Car03_Parts - Color, metallic and smothness are defined by textures. You can find 2 different texture sets for the parts, one has Chromed details and another has black plastic)
